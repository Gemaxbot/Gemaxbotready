    ...
    try:
        ...
        try:
            ...
            if "429" in str(api_err):
                reply_text = "⏳ El asistente está recibiendo muchas consultas simultáneas y ha alcanzado temporalmente el límite de la cuota gratuita. Por favor, espera unos segundos e inténtalo de nuevo."
            else:
                reply_text = "⚠️ Ocurrió un error temporal al procesar tu análisis financiero. Inténtalo de nuevo en un momento."

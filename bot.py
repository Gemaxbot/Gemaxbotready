...
# Configuración de Flask para recibir webhooks de Telegram y abrir el puerto de Render
app = Flask(__name__)
...
# Inicializar la aplicación de Telegram sin polling
...
def webhook():
    ...
    # Ejecutar de forma síncrona el procesamiento de la actualización
    import asyncio
...
@app.route("/")
def index():
    return "GEMAXBOT Webhook Server is running!"

if __name__ == "__main__":
    # Inicialización local o de prueba

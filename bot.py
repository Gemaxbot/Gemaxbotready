...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Si estamos en un grupo o supergrupo, exigimos mención o respuesta directa
    ...
    # Si es chat privado (chat_type == 'private'), procesa y responde directamente cualquier mensaje.

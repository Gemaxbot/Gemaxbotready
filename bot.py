...
# Servidor Flask mínimo para satisfacer el requisito de puertos en Render
app_flask = Flask(__name__)

@app_flask.route('/')
def home():
    return "GEMAXBOT está activo 24/7 en la nube."
...
def main():
    # Iniciar Flask en un hilo separado para cumplir con el puerto web de Render
    ...
    print("GEMAXBOT iniciado correctamente en Render...")
